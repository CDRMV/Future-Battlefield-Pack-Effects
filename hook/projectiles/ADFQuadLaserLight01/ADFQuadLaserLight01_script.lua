...
local TurboLaserblueProjectile = Class(SinglePolyTrailProjectile) {
    ...
    PolyTrail = '/mods/Future Battlefield Pack Effects/effects/Emitters/Lasergreen01_emit.bp',
...
ADFQuadLaserLight01 = Class(TurboLaserblueProjectile) {}

TypeClass = ADFQuadLaserLight01