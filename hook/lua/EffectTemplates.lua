...
HookModPath = '/mods/Future Battlefield Pack Effects/hook/effects/Emitters/'
ModPath = '/mods/Future Battlefield Pack Effects/effects/Emitters/'
...
DefaultProjectileWaterImpact = {
    ModPath .. 'small_water_splash_ring_01_emit.bp',
    ModPath .. 'small_water_splash_wash_01_emit.bp',
    ModPath .. 'small_water_splash_tower_01_emit.bp',
}
...
TIFArtilleryMuzzleFlash = {
	...
	ModPath .. 'gauss_cannon_muzzle_smoke_03_emit.bp',
